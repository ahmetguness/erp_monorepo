...
export declare const ACCESS_POLICIES: {
  readonly purchasing: AccessPolicy;
  readonly approvals: AccessPolicy;
  readonly apiKeys: AccessPolicy;
  readonly roles: AccessPolicy;
  readonly deliveryNotes: AccessPolicy;
  readonly eDocuments: AccessPolicy;
  readonly bankTransactions: AccessPolicy;
  readonly checkPromissory: AccessPolicy;
  readonly reconciliations: AccessPolicy;
  readonly stockValuations: AccessPolicy;
  readonly reservations: AccessPolicy;
  readonly productBatches: AccessPolicy;
  readonly lotSerials: AccessPolicy;
  readonly production: AccessPolicy;
  readonly service: AccessPolicy;
  readonly marketplace: AccessPolicy;
  readonly hr: AccessPolicy;
  readonly payroll: AccessPolicy;
  readonly mail: AccessPolicy;
  readonly chat: AccessPolicy;
  readonly aiGovernance: AccessPolicy;
};
