...
export function WorkOrdersPage() {
  ...
  const columns: ColumnDef<WorkOrder>[] = [
    {
      ...
      header: "No",
      width: "120px",
      render: (r) => <span className="font-mono text-sky-400">{r.number}</span>,
    },
    {
      key: "product",
      header: "Ürün",
    ...
    },
    {
      ...
      render: (r) => (
        <button
          onClick={(e) => {
            e.stopPropagation();
            router.push(`/dashboard/production/work-orders/${r.id}`);
          }}
  ...
  return (
    <div>
      <PageHeader
        title="İş Emirleri"
        subtitle="Üretim iş emirlerini takip edin."
        action={
          <Link
      ...
      <DataTable
        ...
        emptyDescription="Yeni bir iş emri oluşturarak başlayın."
        pagination={
          data
            ? {
                page,
