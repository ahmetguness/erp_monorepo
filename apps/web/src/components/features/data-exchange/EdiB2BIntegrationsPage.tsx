...
import { ArrowLeftRight, CheckCircle2, FileCheck, FileText, Link2, ShieldAlert, Truck } from 'lucide-react';
import { Badge } from '@/components/ui/Badge';
import { FeatureGate } from '@/components/shared/FeatureGate';
import { PageHeader } from '@/components/shared/PageHeader';
import { useEdiB2BHub } from '@/hooks/useDataExchange';
import type { EdiB2BExchangeStatus } from '@/services/data-exchange.service';
            ...
            <section className="grid gap-4 xl:grid-cols-[0.95fr_1.05fr]">
              ...
              <div className="rounded-lg border border-slate-800 bg-slate-900/40 p-4">
                <div className="mb-4 flex items-center gap-2">
                  ...
                  <h2 className="text-sm font-semibold text-slate-200">Son B2B kuyruğu</h2>
                </div>
