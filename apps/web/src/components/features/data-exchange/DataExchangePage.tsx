...
import { Download, FileSpreadsheet, Info, ShieldCheck, UploadCloud } from 'lucide-react';
import { useRef, useState } from 'react';
import { Badge } from '@/components/ui/Badge';
import { Button } from '@/components/ui/Button';
import { PageHeader } from '@/components/shared/PageHeader';
import { useDataExport, useImportPreview, useTemplateDownload } from '@/hooks/useDataExchange';
...
export function DataExchangePage() {
  ...
  async function handlePreview() {
    try {
      await preview.mutateAsync({ entity, csv });
    } catch (error) {
      toast.error(getErrorMessage(error));
    }
  }
