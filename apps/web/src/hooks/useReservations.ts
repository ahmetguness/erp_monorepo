...
export function useCreateReservation() {
  ...
  return useMutation({
    ...
    onSuccess: () => { qc.invalidateQueries({ queryKey: ['reservations'] }); toast.success('Rezervasyon oluşturuldu.'); },
...
export function useReleaseReservation() {
  ...
  return useMutation({
    ...
    onSuccess: () => { qc.invalidateQueries({ queryKey: ['reservations'] }); toast.success('Rezervasyon serbest bırakıldı.'); },
    onError: (e: unknown) => toast.error(getErrorMessage(e)),
  });
}
