...
const GROUPS: SettingsGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/dashboard/settings/domain-events', icon: Database, label: 'Domain Event Hatalari', description: 'Outbox failure ve dead-letter replay işlemleri', color: 'text-amber-400', bg: 'bg-amber-500/10', ring: 'group-hover:ring-amber-500/20' },
