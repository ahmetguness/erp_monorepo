...
function SupportSessionsContent() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative overflow-hidden rounded-2xl border border-indigo-500/20 bg-gradient-to-br from-slate-900 via-indigo-950/20 to-slate-950 p-6 shadow-2xl backdrop-blur-xl">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          <div className="flex items-start gap-4">
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-indigo-500/10 text-indigo-400 ring-1 ring-indigo-500/30 shadow-inner">
              <LifeBuoy className="h-6 w-6" />
            </div>
            <div>
              <div className="flex flex-wrap items-center gap-2">
                <h1 className="text-xl font-bold tracking-tight text-white">Güvenli Destek Oturumu Yönetimi</h1>
                <span className="rounded-full bg-indigo-500/10 px-2.5 py-0.5 text-[10px] font-bold text-indigo-300 ring-1 ring-indigo-500/20 flex items-center gap-1">
              ...
              <p className="mt-1 text-xs text-slate-400 max-w-2xl leading-relaxed">
                Kiracı kullanıcısı yetkisiyle sınırlı, süre ayarlı ve doğrudan kiracı sahibi onayı gerektiren geçici
                destek oturumları oluşturun ve yönetin.
              </p>
            </div>
          </div>

          {/* Quick Stats or Tenant Switcher */}
          {tenantId && (
            <div className="flex items-center gap-2">
              <Button
                variant="ghost"
        ...
        {tenantId && (
          <div className="mt-5 grid grid-cols-1 md:grid-cols-2 gap-3 pt-4 border-t border-slate-800/80">
            {/* Tenant Card */}
