...
export function registerProgrammaticHttpSurface(app: Hono): void {
  app.post(
    "/api/public/trendyol/webhook/:integrationId",
    TrendyolWebhookController.handle,
  );
  app.post(
    "/api/public/marketplace/webhook/:integrationId",
    TrendyolWebhookController.handle,
  );
...
export function registerPublicHttpSurface(app: Hono): void {
  ...
  app.post(
    ...
    SetPasswordController.validateToken,
  );
}
