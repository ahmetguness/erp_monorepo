...
export const switchTenantBodySchema = z
  .object({
...
export const invoiceLineBodySchema = z
  .object({
...
export const fulfillSalesOrderBodySchema = z
  .object({
...
export const businessRuleBodySchema = z
  .object({
    key: nonEmptyString,
    value: jsonValue,
  })
...
export const moduleSettingBodySchema = z
  .object({
...
export const salesTargetBodySchema = z
  .object({
    month: z
      .string()
      .regex(/^\d{4}-(0[1-9]|1[0-2])$/, "Ay YYYY-MM formatinda olmalidir."),
    targetAmount: nonNegativeNumber,
  })
  .strict();

export const productQuickImportBodySchema = z
  .object({
    csv: z.string(),
...
const productPlanningFieldsSchema = z.object({
  safetyStock: optionalNonNegativeNumber,
  reorderPoint: optionalNonNegativeNumber,
  reorderQty: optionalNonNegativeNumber,
...
export const createProductBodySchema = z
  ...
  .extend(productPlanningFieldsSchema.shape)
  .strict();
...
export type FinalizeStockCountBody = z.infer<
  typeof finalizeStockCountBodySchema
>;
export type CreateUserBody = z.infer<typeof createUserBodySchema>;
export type UpdateUserBody = z.infer<typeof updateUserBodySchema>;
export type SalesTargetBody = z.infer<typeof salesTargetBodySchema>;
export type ProductQuickImportBody = z.infer<
  typeof productQuickImportBodySchema
>;
