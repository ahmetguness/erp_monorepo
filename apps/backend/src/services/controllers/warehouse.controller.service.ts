...
import { assertCanConsumeStock, resolveStockLevelLocationId, recordInventoryCosting } from '../inventory-rules.service';
import { WarehouseInsightsService } from '../warehouse-insights.service.js';
