...
export const DOMAIN_EVENT_PUBLISH_COVERAGE = [
  {
    ...
    producer: 'apps/backend/src/modules/sales/http/controllers/sales-order.controller.ts',
    status: 'planned',
  ...
  },
  {
    ...
    producer: 'apps/backend/src/modules/sales/http/controllers/invoice.controller.ts',
    status: 'covered',
  ...
  },
  {
    ...
    eventName: 'stock.low',
    producer: 'apps/backend/src/modules/inventory/http/controllers/stock.controller.ts',
    status: 'covered',
  ...
  },
  {
    ...
    producer: 'apps/backend/src/modules/sales/http/controllers/delivery-note.controller.ts',
    status: 'planned',
  ...
  },
  {
    ...
    producer: 'apps/backend/src/modules/procurement/http/controllers/purchase-order.controller.ts',
    status: 'planned',
  ...
  },
  {
    ...
    producer: 'apps/backend/src/modules/production/http/controllers/work-order.controller.ts',
    status: 'covered',
