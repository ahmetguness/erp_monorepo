...
masterDataRoutes.get(
  ...
  MasterDataController.listUnits,
);
...
masterDataRoutes.get(
  "/categories",
  requirePermission("settings", "READ"),
  MasterDataController.listCategories,
);
masterDataRoutes.post(
  "/categories",
  requirePermission("settings", "CREATE"),
...
masterDataRoutes.get(
  "/tax-rates",
  requirePermission("settings", "READ"),
  MasterDataController.listTaxRates,
);
masterDataRoutes.post(
  "/tax-rates",
  requirePermission("settings", "CREATE"),
  MasterDataController.createTaxRate,
);
masterDataRoutes.patch(
  "/tax-rates/:id",
  requirePermission("settings", "UPDATE"),
  MasterDataController.updateTaxRate,
);

masterDataRoutes.get(
  "/currencies",
  requirePermission("settings", "READ"),
  MasterDataController.listCurrencies,
);
masterDataRoutes.post(
  "/currencies",
  requirePermission("settings", "CREATE"),
  MasterDataController.createCurrency,
);
