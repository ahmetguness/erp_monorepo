...
attachmentRoutes.get(
  ...
  AttachmentController.library,
);
attachmentRoutes.get(
  "/entity-options",
  requirePermission("attachments", "READ"),
  AttachmentController.entityOptions,
);
attachmentRoutes.get(
  "/",
  requirePermission("attachments", "READ"),
...
attachmentRoutes.post(
  ...
  AttachmentController.bulkMetadata,
);
attachmentRoutes.get(
  "/:id/access-log",
  requirePermission("attachments", "READ"),
  AttachmentController.accessLog,
);
attachmentRoutes.post(
  "/:id/version",
  requirePermission("attachments", "CREATE"),
  AttachmentController.uploadVersion,
);
attachmentRoutes.get(
  "/:id/signed-url",
  requirePermission("attachments", "READ"),
  AttachmentController.signedDownloadUrl,
);
attachmentRoutes.get(
  "/:id/download",
  requirePermission("attachments", "READ"),
