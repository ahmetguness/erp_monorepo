    ...
    return c.json(
      {
        error: "Unauthorized",
        message:
          "BI Connector token bulunamadı. Lütfen Authorization header veya token parametresi gönderin.",
      },
      401,
    );
  }
    ...
    return c.json(
      {
        error: "Forbidden",
        message:
          "BI veri ambarı bağlayıcısı özelliği sadece Enterprise plan müşterileri içindir.",
      },
      403,
    );
  }
