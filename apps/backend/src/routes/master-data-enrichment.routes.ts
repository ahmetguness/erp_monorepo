...
masterDataEnrichmentRoutes.post(
  "/contact/preview",
  requirePermission("contacts", "READ"),
  validateBody(contactMasterDataEnrichmentSchema),
  MasterDataEnrichmentController.preview,
);
masterDataEnrichmentRoutes.post(
  "/product/preview",
  requirePermission("inventory", "READ"),
  validateBody(productMasterDataEnrichmentSchema),
  MasterDataEnrichmentController.preview,
);
masterDataEnrichmentRoutes.post(
  "/bankAccount/preview",
  requirePermission("accounting", "READ"),
  validateBody(bankAccountMasterDataEnrichmentSchema),
  MasterDataEnrichmentController.preview,
);
