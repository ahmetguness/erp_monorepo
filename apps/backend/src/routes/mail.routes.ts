...
import { MailController } from "../modules/platform/http/controllers/index.js";
...
mailRoutes.get(
  "/templates/lifecycle",
  requirePermission("mail", "READ"),
  MailController.templateLifecycle,
);
mailRoutes.post(
  "/templates/custom",
  requirePermission("mail", "CREATE"),
  MailController.createTemplate,
);
mailRoutes.put(
  "/templates/custom/:id",
  requirePermission("mail", "UPDATE"),
  MailController.updateTemplate,
);
mailRoutes.post(
  "/templates/custom/:id/approval",
  requirePermission("mail", "UPDATE"),
  MailController.approveTemplate,
);
mailRoutes.delete(
  "/templates/custom/:id",
  requirePermission("mail", "DELETE"),
  MailController.deleteTemplate,
);
mailRoutes.post(
  "/templates/render",
  requirePermission("mail", "CREATE"),
  MailController.renderTemplate,
);
mailRoutes.post(
  "/ai-draft",
  requirePermission("mail", "CREATE"),
  MailController.aiDraft,
);
...
mailRoutes.post(
  ...
  requirePermission("mail", "CREATE"),
  MailController.sendInvoiceNotification,
);
mailRoutes.post(
  "/notification",
  requirePermission("mail", "CREATE"),
