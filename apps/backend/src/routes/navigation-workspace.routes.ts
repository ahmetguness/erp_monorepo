...
navigationWorkspaceRoutes.patch(
  "/preferences",
  NavigationWorkspaceController.update,
);
navigationWorkspaceRoutes.post(
  "/activity",
  NavigationWorkspaceController.activity,
);
navigationWorkspaceRoutes.put(
  "/profiles/:roleId",
  NavigationWorkspaceController.distribute,
);
