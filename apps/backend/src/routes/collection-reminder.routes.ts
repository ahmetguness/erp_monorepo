...
collectionReminderRoutes.get(
  "/",
  requirePermission("accounting", "READ"),
  CollectionReminderController.list,
);
collectionReminderRoutes.post(
  "/automation/run",
  requirePermission("accounting", "UPDATE"),
  CollectionReminderController.runAutomation,
);
collectionReminderRoutes.post(
  "/",
  requirePermission("accounting", "CREATE"),
  validateBody(createCollectionReminderBodySchema),
  CollectionReminderController.create,
);
...
collectionReminderRoutes.delete(
  ...
  CollectionReminderController.remove,
);
