...
accountingRoutes.get(
  "/accounts/:id",
  requirePermission("accounting", "READ"),
  AccountingExtController.getAccountById,
);
accountingRoutes.patch(
  "/accounts/:id",
  requirePermission("accounting", "UPDATE"),
  AccountingExtController.updateAccount,
);
...
accountingRoutes.get(
  "/journal-entries/:id",
  requirePermission("accounting", "READ"),
  AccountingExtController.getJournalEntryById,
);
accountingRoutes.post(
...
accountingRoutes.get(
  "/fiscal-periods",
  requirePermission("accounting", "READ"),
  AccountingExtController.listFiscalPeriods,
);
accountingRoutes.post(
  "/fiscal-periods",
  requirePermission("accounting", "CREATE"),
  AccountingExtController.createFiscalPeriod,
);
accountingRoutes.get(
  "/fiscal-periods/:id/closing-checklist",
  requireAccess(ACCESS_POLICIES.reconciliations),
  requirePermission("accounting", "READ"),
  AccountingExtController.getFiscalPeriodClosingChecklist,
);
accountingRoutes.post(
  "/fiscal-periods/:id/close",
  requirePermission("accounting", "UPDATE"),
  AccountingExtController.closeFiscalPeriod,
);
accountingRoutes.post(
  "/fiscal-periods/:id/lock",
  requirePermission("accounting", "UPDATE"),
  AccountingExtController.lockFiscalPeriod,
);
accountingRoutes.post(
  "/fiscal-periods/:id/reopen",
  requirePermission("accounting", "UPDATE"),
  AccountingExtController.reopenFiscalPeriod,
);
accountingRoutes.delete(
  "/fiscal-periods/:id",
  requirePermission("accounting", "DELETE"),
  AccountingExtController.deleteFiscalPeriod,
);
...
accountingRoutes.get(
  "/trial-balance",
  requirePermission("accounting", "READ"),
  AccountingExtController.getTrialBalance,
);
accountingRoutes.get(
  "/account-statement/:contactId",
  requirePermission("accounting", "READ"),
  AccountingExtController.getContactStatement,
);
