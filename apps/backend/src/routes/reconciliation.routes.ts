...
import { ReconciliationController } from "../modules/finance/http/controllers/index.js";
...
reconciliationRoutes.get(
  "/:id",
  requirePermission("accounting", "READ"),
  ReconciliationController.getById,
);
...
reconciliationRoutes.post(
  ...
  ReconciliationController.addLine,
);
reconciliationRoutes.post(
  "/:id/finalize",
  requirePermission("accounting", "UPDATE"),
  ReconciliationController.finalize,
);
