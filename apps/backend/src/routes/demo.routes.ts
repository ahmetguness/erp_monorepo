...
demoAdminRoutes.get(
  "/demo-requests",
  requireAdmin,
  requireAdminPermission("demo.read"),
  DemoController.list,
);
demoAdminRoutes.get(
  "/demo-requests/:id/preview",
  requireAdmin,
  requireAdminPermission("demo.approve"),
  DemoController.preview,
);
demoAdminRoutes.get(
  "/demo-requests/:id",
  requireAdmin,
  requireAdminPermission("demo.read"),
  DemoController.getById,
);
demoAdminRoutes.post(
  "/demo-requests/:id/approve",
  requireAdmin,
  requireAdminPermission("demo.approve"),
  requireRecentAdminMfa,
  DemoController.approve,
);
demoAdminRoutes.post(
  "/demo-requests/:id/reject",
  requireAdmin,
  requireAdminPermission("demo.reject"),
  requireRecentAdminMfa,
  DemoController.reject,
);
demoAdminRoutes.post(
